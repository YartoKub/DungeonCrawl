...
public class GradientTest : MonoBehaviour
{
    ...
    [SerializeField]private GradientTestOption option;
        ...
        for (int i = 0; i < subdivisions; i++)
        {
            ...
            switch (option)
            {
                ...
                case GradientTestOption.Lerp:
                    ...
                    break;
                case GradientTestOption.HSVGradient:
